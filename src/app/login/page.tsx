            ...
            >
                ...
                <div className="bg-card border border-border p-10 rounded-[3rem] shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="mt-8 text-center text-sm">
                        <span className="text-muted-foreground font-medium italic">Don't have an account? </span>
                        <Link href="/register" className="text-primary font-black uppercase tracking-widest text-xs hover:underline underline-offset-4 ml-1">
                            Create Account
                        </Link>
                    </div>
                </div>
